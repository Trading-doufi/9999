                ...
                for symbol in self.symbols:
                    ...
                    if score >= self.min_score:
                        ...
                        signal = {
                            ...
                            'reason': f"Score {round(score, 1)}% - {'Liquidation' if liquidation_detected else 'Technical'}"
                        }
                        ...
                        logger.info(f"✅ PROFESSIONAL SIGNAL: {symbol} - {direction} - Score: {round(score, 1)}")
